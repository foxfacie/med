...
class TypingAnimation {
    ...
    transitionToMainScreen() {
        ...
        setTimeout(() => {
            ...
            transitionElement.className = 'transition-text';
            transitionElement.textContent = 'websiteox';
        ...
        setTimeout(() => {
            ...
            // Удаляем только временные анимационные элементы с текстом "websiteox"
            document.querySelectorAll('.transition-text').forEach(el => {
                if (el.textContent === 'websiteox' && 
                    el !== this.textElement && 
